...
const file_api_helloworld_v1_greeter_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80(R\x04name\"&\n" +
	"\n" +
	"HelloReply\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2i\n" +
	"\aGreeter\x12^\n" +
	"\bSayHello\x12\x1b.helloworld.v1.HelloRequest\x1a\x19.helloworld.v1.HelloReply\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/helloworld/{name}B9Z7github.com/fsyyft-go/dify-extension/api/helloworld/v1;v1b\x06proto3"
